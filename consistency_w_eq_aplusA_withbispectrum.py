...
# trispectrum = pickle.load(open('trispectrum_tsz_rho.p', 'rb'))


#test modified MASTER
print('***********************************************************', flush=True)
print('Testing modified MASTER', flush=True)
compare_master(inp, master_lhs, w00, a00, Cl, Ml, Wl, bispectrum_aaw, bispectrum_waw, trispectrum, my_env, base_dir=f'images/tSZ_w_eq_a_plus_A', plot_log=True)
